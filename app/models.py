...
class Tasks(models.Model):
    ...
    start_date = models.DateField(blank=True, null=True, verbose_name='Дата начала парсинга')
    is_active = models.BooleanField(default=True, verbose_name='Активен ли запрос')
    descriptopn = models.TextField(verbose_name='Описание задачи')


class Messages(models.Model):
    channel_id = models.CharField(verbose_name='Канал сообщения'
                                  )
